  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <p className="text-center max-w-xl text-gray-400 mb-8">
        I'm a passionate Computer Science student focused on AI and Python
        development. I love solving real-world problems and recently built an
        animal threat detection system using ML, Arduino, and sensors. I'm
        constantly learning and building!
      </p>

      <div className="flex gap-4 mb-10">
        <a
          href="https://github.com/Kash1444"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/prakashcodes/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaLinkedin size={28} />
      ...
      <section className="bg-gray-800 p-6 rounded-xl max-w-2xl w-full shadow-lg">
        ...
        <div>
          ...
          <p className="text-gray-300 mt-2">
            Our project focused on sustainable development. Leveraging ML and
            using Arduino, thermal sensor, ultrasonic sensor, Wi-Fi module, and
            motor system, we aimed to detect animal threats effectively. The
            project showcased our skills in ML and IoT, emphasizing
